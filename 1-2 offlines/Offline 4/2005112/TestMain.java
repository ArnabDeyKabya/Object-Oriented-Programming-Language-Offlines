...
public class TestMain {
    public static void main(String[] args) {
        ...
        b[1].addAccount(a[3]); // add the Account to this Branch,n i8ty
        ...
        System.out.println(b[0].getMinBalanceAccount().getCustomer()); // prints the name of the Account with lowest
                                                                       // Balance in this Branch
        System.out.println(b[1].getMinBalanceAccount().getCustomer()); // prints the name of the Account with lowest
                                                                       // Balance in this Branch
        Branch.transferBalance(a[4], a[3], 100); // transfer 100 from balance of Account a[4] to Account a[3]
        Branch.printAllBranchesInfo(); // prints all branches info as follows (this is just a sample, you can't
                                       // hardcode this output)
        /*
